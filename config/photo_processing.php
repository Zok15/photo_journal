...
return [
    ...
    'upload_max_dimension' => max(640, (int) env('PHOTO_UPLOAD_MAX_DIMENSION', 2560)),
    'upload_min_dimension' => max(320, (int) env('PHOTO_UPLOAD_MIN_DIMENSION', 900)),
    'upload_jpeg_quality_start' => max(40, min(100, (int) env('PHOTO_UPLOAD_JPEG_QUALITY_START', 88))),
    'upload_jpeg_quality_min' => max(25, min(95, (int) env('PHOTO_UPLOAD_JPEG_QUALITY_MIN', 45))),
