...
return [
    ...
    'model_version' => (string) env('VISION_TAGGER_MODEL_VERSION', 'v1'),
    'timeout_seconds' => (int) env('VISION_TAGGER_TIMEOUT', 10),
    'health_timeout_seconds' => (int) env('VISION_TAGGER_HEALTH_TIMEOUT', 6),
    ...
    'cache_ttl_seconds' => (int) env('VISION_TAGGER_CACHE_TTL_SECONDS', 86400),
];
